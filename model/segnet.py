...
#    conv1_down = BatchNormalization()(conv1_down)
    ...
    conv2_down = Conv1D(filters=n_filters_in_most_shallow_layer*2, kernel_size=filter_width, strides=1, activation = None, padding = 'same', kernel_initializer = 'he_normal', name='conv2_down1', activity_regularizer=regularizers.l2(l2_regularization_parameter))(pool1)
#    conv2_down = BatchNormalization()(conv2_down)
    conv2_down = Activation('relu')(conv2_down)
    conv2_down = Dropout(dropout_rate)(conv2_down)
    conv2_down = Conv1D(filters=n_filters_in_most_shallow_layer*2, kernel_size=filter_width, strides=1, activation = None, padding = 'same', kernel_initializer = 'he_normal', name='conv2_down2', activity_regularizer=regularizers.l2(l2_regularization_parameter))(conv2_down)
#    conv2_down = BatchNormalization()(conv2_down)
    conv2_down = Activation('relu')(conv2_down)
    conv2_down = Dropout(dropout_rate)(conv2_down)
...
#    conv3_up = BatchNormalization()(conv3_up)
    ...
    conv2_up = Conv1D(filters=n_filters_in_most_shallow_layer*2, kernel_size=filter_width, strides=1, activation = None, padding = 'same', kernel_initializer = 'he_normal', name='conv2_up1', activity_regularizer=regularizers.l2(l2_regularization_parameter))(up2)
#    conv2_up = BatchNormalization()(conv2_up)
    conv2_up = Activation('relu')(conv2_up)
    conv2_up = Dropout(dropout_rate)(conv2_up)
    conv2_up = Conv1D(filters=n_filters_in_most_shallow_layer*2, kernel_size=filter_width, strides=1, activation = None, padding = 'same', kernel_initializer = 'he_normal', name='conv2_up2', activity_regularizer=regularizers.l2(l2_regularization_parameter))(conv2_up)
#    conv2_up = BatchNormalization()(conv2_up)
    conv2_up = Activation('relu')(conv2_up)
    conv2_up = Dropout(dropout_rate)(conv2_up)
