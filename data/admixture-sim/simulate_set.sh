...
if [ $# -ne 3 ]; then
	echo "usage: bash $0 in_pop n_generations chrom"
	exit 1
else
	in_pop=$1 # one of dev, test
	G=$2      # 3, 10, 30
	c=$3  # chromosome -- make sure this matches ref_map above
fi
...
out="/home/magu/deepmix/data/reference_panel/simulated_chr${c}/vcf/${in_pop}_${G}gen" 
